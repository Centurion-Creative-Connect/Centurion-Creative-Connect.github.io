    ...
    themeConfig: /** @type {import('@docusaurus/preset-classic').ThemeConfig} */
        ({
            image: 'img/ccc-social-card.jpg', navbar:
                {
                    title: 'Centurion Creative Connect',
                    logo: {
                        alt: 'Centurion Creative Connect Logo',
                        src: 'img/logo.svg',
                ...
                links: [
                    {
                        ...
                        items: [
                            ...
                            // {label: 'System.VoiceCommsIntegration', href: 'https://vci.system.centurioncc.org/'},
                        ],
                    },
                    {
                        title: 'Community',
                        items: [
                            ...
                            {
                                label: 'Discord',
                                href: 'https://discord.com/invite/y66JZ4kAp8',
                            },
                        ],
                    },
                    {
